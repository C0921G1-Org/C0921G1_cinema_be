...
public class Controller_EditFilm {
    @Autowired
    ...
    @Test
    public  void editFilm_13_duration_null() throws  Exception{
...
//        filmDTO.setFlagDelete(0);
    ...
    @Test
    public  void editFilm_13_startDay_null() throws  Exception{
        FilmDTO filmDTO = new FilmDTO();
        filmDTO.setName("Funy Boy");
...
//        filmDTO.setFlagDelete(0);
    ...
    @Test
    public  void editFilm_13_endDay_null() throws  Exception{
        FilmDTO filmDTO = new FilmDTO();
        filmDTO.setName("Funy Boy");
        filmDTO.setDuration("60");
        filmDTO.setStartDate("2022-03-01");
...
//        filmDTO.setFlagDelete(0);
    ...
    @Test
    public  void editFilm_14_duration_rong() throws  Exception{
        FilmDTO filmDTO = new FilmDTO();
        filmDTO.setName("Funy Boy");
        filmDTO.setDuration("");
        filmDTO.setStartDate("2022-03-01");
...
//        filmDTO.setFlagDelete(0);
    ...
    @Test
    public  void editFilm_14_startDay_rong() throws  Exception{
        FilmDTO filmDTO = new FilmDTO();
        filmDTO.setName("Funy Boy");
...
//        filmDTO.setFlagDelete(0);
    ...
    @Test
    public  void editFilm_14_endDay_rong() throws  Exception{
        FilmDTO filmDTO = new FilmDTO();
        filmDTO.setName("Funy Boy");
        filmDTO.setDuration("60p");
        filmDTO.setStartDate("2022-03-01");
...
//        filmDTO.setFlagDelete(0);
    ...
    // duration sai format
    @Test
    public  void editFilm_15_duration_format() throws  Exception{
        FilmDTO filmDTO = new FilmDTO();
        filmDTO.setName("Funy Boy");
...
//        filmDTO.setFlagDelete(0);
    ...
    @Test
    public  void editFilm_15_startDay_format() throws  Exception{
        FilmDTO filmDTO = new FilmDTO();
        filmDTO.setName("Funy Boy");
        filmDTO.setDuration("60p");
...
//        filmDTO.setFlagDelete(0);
    ...
    @Test
    public  void editFilm_15_endDay_format() throws  Exception{
        FilmDTO filmDTO = new FilmDTO();
        filmDTO.setName("Funy Boy");
        filmDTO.setDuration("60p");
        filmDTO.setStartDate("2022-03-01");
...
//        filmDTO.setFlagDelete(0);
    ...
    @Test
    public  void editFilm_18() throws  Exception{
        FilmDTO filmDTO = new FilmDTO();
        filmDTO.setName(" Funy Boy");
        filmDTO.setDuration("60p");
        filmDTO.setStartDate("2022-03-01");
